...
いま 7 個の未証明義務を `axiom` として持っている。下の guard がその一覧を固定するので、
...
/-- info: 'PalPeg.PalInPeg.unconditional' depends on axioms: [propext,
 Classical.choice,
 Quot.sound,
 PalPeg.PalInPeg.obligation_backgroundLandingPayload,
 PalPeg.PalInPeg.obligation_cycleOracle,
 PalPeg.PalInPeg.obligation_localRealization,
 PalPeg.PalInPeg.obligation_marksEntry,
 PalPeg.PalInPeg.obligation_matchLandingPayload,
 PalPeg.PalInPeg.obligation_shiftExitPayload,
